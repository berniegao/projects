...
<div>
    <ct:ASTreeView ID="astvMyTree" runat="server" 
        BasePath="~/Scripts/Javascript/astreeview/themes/macOS"
        ...
        DefaultFolderIcon="~/Scripts/Javascript/astreeview/themes/macOS/images/astreeview-folder.gif"
        DefaultFolderOpenIcon="~/Scripts/Javascript/astreeview/themes/macOS/images/astreeview-folder-open.gif"

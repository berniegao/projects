...
namespace Votations.NSurvey.WebAdmin.NSurveyAdmin.UserControls
{
    public partial class SurveyTree : System.Web.UI.UserControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            css.Attributes.Add("href", ResolveUrl("~/Scripts/javascript/astreeview/astreeview.css"));
            ...
            css.Attributes.Add("rel", "stylesheet");
            css.Attributes.Add("type", "text/css");
            css.Attributes.Add("href", ResolveUrl("~/Scripts/javascript/contextmenu/contextmenu.css"));
            Page.Header.Controls.Add(css);
            Page.Header.Controls.Add(new LiteralControl(Environment.NewLine));
            ...
            css.Attributes.Add("rel", "stylesheet");
            css.Attributes.Add("type", "text/css");
            css.Attributes.Add("href", ResolveUrl("~/Scripts/javascript/astreeview/themes/macOS/macOS.css"));
            Page.Header.Controls.Add(css);

            Page.Header.Controls.Add(new LiteralControl(Environment.NewLine));
            HtmlGenericControl javascriptControl = new HtmlGenericControl("script");
            javascriptControl.Attributes.Add("type", "text/Javascript");
            javascriptControl.Attributes.Add("src", Page.ResolveUrl("~/Scripts/Javascript/astreeview/astreeview_packed.js"));
            Page.Header.Controls.Add(javascriptControl);
            Page.Header.Controls.Add(new LiteralControl(Environment.NewLine));

            javascriptControl = new HtmlGenericControl("script");
            javascriptControl.Attributes.Add("type", "text/Javascript");
            javascriptControl.Attributes.Add("src", Page.ResolveUrl("~/Scripts/javascript/contextmenu/contextmenu_packed.js"));
            Page.Header.Controls.Add(javascriptControl);
            Page.Header.Controls.Add(new LiteralControl(Environment.NewLine));

            ASTreeViewTheme macOS = new ASTreeViewTheme();
            macOS.BasePath = "~/Scripts/javascript/astreeview/themes/macOS/";

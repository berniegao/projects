...
Field types are the different type of objects to choose from that can be used to have the respondent submit information or answers. 
Field types range from basic textboxes to complex field types like HTML editors, calendars or slider
fields. It is very easy to create new field types using the online Answer Type Creator.
<br />
<br />

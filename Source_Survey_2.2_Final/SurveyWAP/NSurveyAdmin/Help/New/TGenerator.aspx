    ...
    <table class="TableLayoutContainer">
        ...
        <tr>
            <td class="contentCell" valign="top">
                ...
                <br />
Survey provides out of the box a tool to generate automatically, create
or import authentication tokens for our survey.    <br />
<br />
Token Generator<br />
<br />
* Number Of Tokens To Generate is the number of token we want to
  generate. Note that a token can only be once in the token list unless

...
<br />
This field has a client side validation script to make sure that a
correct email has been provided. It is recommended to also activate the
Regular expression's email validation.<br />
<br />
Type Settings<br />
<br />
...
<br />
  ...
  @@yoursessionvariablename@@ will set the default text with a session<br />
  variable's value.<br />

        ...
        <tr>
            <td class="contentCell" valign="top">
                ...
                <h2 style="color:#5720C6;">
                    Constant Sum Tutorial</h2>
                <br />
                <br />
                <hr style="color:#e2e2e2;"/>
                <br />
In this tutorial we will see how to use and setup a question to force a
responded to share a given sum across multiple answers.<br />
<br />

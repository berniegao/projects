    ...
    <table class="TableLayoutContainer">
        ...
        <tr>
            <td class="contentCell" valign="top">
                ...
                <br />
This type will render a password textbox but from which text cannot be
read.<br />
<br />
...
<br />
* RegEx Server Side Validation  allows us to validate the content of
  the textbox field using a regular expression. Several regular
  expression validation are provided out of the box and it is very easy
  to create new one using the Regular%20Expression%20Editor.html. This
  check is done server-side.<br />
<br />

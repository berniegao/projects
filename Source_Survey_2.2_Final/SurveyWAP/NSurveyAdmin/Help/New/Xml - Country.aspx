...
This type is bound to and will read the country xml file located in the
XmlData directory to show a list of countries, it is also possible to
create our own Xml bound type using the Answer%20Type%20Creator.html.<br />
<br />
...
<br />
* Mandatory allows us to set if the dropdown list requires at least one
  selection. This check is done server-side.<br />
<br />

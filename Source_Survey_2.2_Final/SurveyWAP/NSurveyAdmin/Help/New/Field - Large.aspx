...
This type will render a big textbox that support multiple lines comments
from the respondent. You can use this type if you except a large amount
of comments from your respondents. There is no maximum length limit by
default. If we need a to change the size of the field or its properties
it is possible to create our own field type using the<br />
